...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/NeslihanCanbaz/Python_Modul_Week_3.git
   cd Python_Modul_Week_3
   ```

2. Make sure Python 3 is installed (no external dependencies are required).

3. Run the library system:

   ```bash
   python library.py
   ```

4. Follow the on-screen prompts to log in, create an account, or manage books.
